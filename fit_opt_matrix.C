...
void fit_opt_matrix(TString fname="Optics_1814_1919_shms_newfit3_tree") {
 ...
 //
   string newcoeffsfilename="SHMS_OPTICS_A1N/newfit.dat";
     string oldcoeffsfilename="SHMS_OPTICS_A1N/shms_newfit_april2020.dat";
  int nfit=0,npar,nfit_max=50000,npar_final=0,max_order=6,norder;
  Int_t MaxPerBin=200;
