...
void fit_opt_matrix_v2() {
  ...
  vector<int> runTot;
  runTot.push_back(10301);
  runTot.push_back(10776);
  runTot.push_back(10786);
  runTot.push_back(10790);
  ...
  int nfit=0,npar,nfit_max=148292,npar_final=0,max_order=6,norder;
  Int_t MaxPerBin=200;
